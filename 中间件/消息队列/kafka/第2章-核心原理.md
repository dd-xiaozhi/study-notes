...
stateDiagram-v2
    ...
    Stable --> [*]: 关闭消费者
    Rebalancing --> [*]: 异常退出
    class Stable,Rebalancing primary
```
...
stateDiagram-v2
    ...
    ISR同步 --> Normal: 恢复正常
    Leader故障 --> [*]: 全部副本不可用
    class Normal,Leader故障,NewLeader在线,ISR同步 primary
    class 选举新Leader warning
```
...
flowchart TD
    ...
    class A,A1,A2,A3,A4,A5 primary
```
